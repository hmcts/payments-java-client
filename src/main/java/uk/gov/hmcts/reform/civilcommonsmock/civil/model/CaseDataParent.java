...
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.caseprogression.EvidenceUploadDisclosure;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.caseprogression.EvidenceUploadExpert;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.caseprogression.EvidenceUploadTrial;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.caseprogression.EvidenceUploadWitness;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.dj.*;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.dq.Language;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.finalorders.AssistedCostTypesList;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.finalorders.FinalOrderToggle;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.finalorders.HearingLengthFinalOrderList;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.finalorders.OrderMadeOnTypes;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.hearing.HearingChannel;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.hearing.HearingDuration;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.hearing.HearingNoticeList;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.hearing.ListingOrRelisting;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.sdo.*;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.show.DefendantResponseShowTag;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.show.ResponseOneVOneShowTag;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.caseflags.Flags;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.caseprogression.*;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.citizenui.CaseDataLiP;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.citizenui.ClaimantMediationLip;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.citizenui.RespondentLiPResponse;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.citizenui.TranslatedDocument;
...
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.dq.Witnesses;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.finalorders.*;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.noc.ChangeOrganisationRequest;
...
public class CaseDataParent implements MappableObject {
    ...
    public boolean isResponseAcceptedByClaimant() {
        return applicant1AcceptAdmitAmountPaidSpec == YES
