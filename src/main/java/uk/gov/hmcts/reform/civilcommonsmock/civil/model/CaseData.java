...
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.*;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.caseprogression.FinalOrderSelection;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.caseprogression.OrderOnCourtsList;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.dj.DisposalHearingMethodDJ;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.dj.HearingMethodTelephoneHearingDJ;
import uk.gov.hmcts.reform.civilcommonsmock.civil.enums.dj.HearingMethodVideoConferenceDJ;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.breathing.BreathingSpaceInfo;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.caseprogression.FreeFormOrderValues;
...
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.defaultjudgment.*;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.documents.DocumentAndNote;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.documents.DocumentWithName;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.dq.*;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.genapplication.*;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.interestcalc.InterestClaimFromType;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.interestcalc.InterestClaimOptions;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.interestcalc.InterestClaimUntilType;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.interestcalc.SameRateInterestSelection;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.sdo.DisposalHearingFinalDisposalHearingTimeDJ;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.sdo.DisposalHearingHearingNotesDJ;
import uk.gov.hmcts.reform.civilcommonsmock.civil.model.sdo.DisposalHearingOrderMadeWithoutHearingDJ;
import uk.gov.hmcts.reform.civilcommonsmock.civil.notify.service.DeadlinesCalculator;
import uk.gov.hmcts.reform.civilcommonsmock.civil.utils.MonetaryConversions;
...
import static uk.gov.hmcts.reform.civilcommonsmock.civil.enums.AllocatedTrack.FAST_CLAIM;
import static uk.gov.hmcts.reform.civilcommonsmock.civil.enums.AllocatedTrack.SMALL_CLAIM;
import static uk.gov.hmcts.reform.civilcommonsmock.civil.enums.MultiPartyScenario.*;
import static uk.gov.hmcts.reform.civilcommonsmock.civil.enums.RespondentResponseTypeSpec.PART_ADMISSION;
import static uk.gov.hmcts.reform.civilcommonsmock.civil.enums.YesOrNo.NO;
import static uk.gov.hmcts.reform.civilcommonsmock.civil.enums.YesOrNo.YES;
import static uk.gov.hmcts.reform.civilcommonsmock.civil.helpers.DateFormatHelper.DATE_TIME_AT;
import static uk.gov.hmcts.reform.civilcommonsmock.civil.helpers.DateFormatHelper.formatLocalDateTime;
...
//    }
    ...
    public boolean isRespondent1LiP() {
        return NO == getRespondent1Represented();
    }
    ...
    public boolean isRespondent2LiP() {
        return NO == getRespondent2Represented();
    }
    ...
    public boolean isAcceptDefendantPaymentPlanForPartAdmitYes() {
        return YES.equals(getApplicant1AcceptPartAdmitPaymentPlanSpec());
    }
    ...
    public boolean isClaimantIntentionSettlePartAdmit() {
        return YES.equals(getApplicant1PartAdmitIntentionToSettleClaimSpec());
    }
    ...
    public boolean isClaimantConfirmAmountPaidPartAdmit() {
        return YES.equals(getApplicant1PartAdmitConfirmAmountPaidSpec());
    }
